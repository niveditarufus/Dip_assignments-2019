...
im = cv2.imread('panaroma.jpg')# path needs to be channged all input images are available in the input folder
padded_image = padding(im,3,3)
output = sliding_window(im,padded_image,3)
cv2.imwrite('panaroma_med.jpg',output)# output images in the output folder can be used for refrence
