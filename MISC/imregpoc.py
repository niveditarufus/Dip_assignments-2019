...
class imregpoc:
    ...
    def match(self):
        ...
        # plt.imshow(self.LPA_filt, cmap = 'gray')
        # plt.show()
    ...
    def showRotatePeak(self):
        ...
        y = np.amax(self.r_rotatescale, axis = 1)
        # plt.style.use('dark_background')
        plt.plot(x,y)
        plt.title("2D POC peak for estimation of the rotation of angle between two images ")
        plt.xlabel("Angle in degrees")
        plt.ylabel("Value of 2D POC for the two images")
        plt.annotate('peak at '+str(int(x[210]))+ ' deg', xy = (x[210],y[210]),xytext = (-90,0.25),arrowprops=dict(arrowstyle="->",
